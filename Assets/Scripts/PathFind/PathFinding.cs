...
namespace PF {
    ...
    /// List<Vector2Int> path = Pathfinding.FindPath(grid, from, to);
    /// </summary>
    public class Pathfinding {
		...
		public static List<Vector2Int> FindPath(Grid grid, Vector2Int startPos, Vector2Int targetPos, DistanceType distance = DistanceType.Euclidean, bool ignorePrices = false) {
            // find path
        ...
        private static List<Node> _ImpFindPath(Grid grid, Vector2Int startPos, Vector2Int targetPos, DistanceType distance = DistanceType.Euclidean, bool ignorePrices = false) {
